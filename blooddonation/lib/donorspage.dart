                        ...
                        child:Column(
                          children: [
                            Container(
                              ...
                              child: Text("Anna Cruz",style: TextStyle(
                                ...
                                children: [
                                  Container(
                                    ...
                                    Container(
                                      ...
                                      child: Text("gyfgeru",style: TextStyle(
                       ...
                       Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: const Color.fromARGB(255, 196, 194, 194),
                            ...
                            child:Center(child: Text("O+",style: TextStyle(color: Colors.red,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color.fromARGB(255, 185, 71, 63))
                        ),
                        // child: ,
                      ),
                      Container(
                      ...
                      Container(
                       ...
                       Container(
                        ...
                        child: 
                        ClipRRect(child: Image.asset("./images/h.jpg",fit: BoxFit.cover,) ,)
